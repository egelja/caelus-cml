...
- [Turbulence Models](#turbulence-models)
  * [Reynolds Avergaged Navier-Stokes](#reynolds-avergaged-navier-stokes-)
  * [Transition](#transition-)
    + [Wall Functions](#wall-functions-)
  * [Very Large Eddy Simulation](#very-large-eddy-simulation-)
  * [Detached Eddy Simulation](#detached-eddy-simulation-)
  * [Large Eddy Simulation](#large-eddy-simulation-)
    + [Wall Damping](#wall-damping-)
- [_waves_ library](#-waves--library)
- [Installation](#installation)
  * [Windows](#windows)
    + [MPICH2 on Windows](#mpich2-on-windows)
  * [Linux](#linux)
  * [Mac OS X](#mac-os-x)
- [Caelus Python Library](#caelus-python-library)
  * [Usage](#usage)
  * [Workflows](#workflows)
  * [Build](#build)
  * [Parametric Runs](#parametric-runs)
- [Contributors Repository Set Up](#contributors-repository-set-up)
- [CPL Repository Setup](#cpl-repository-setup)
...
The _waves_ library is a port of Niels Gjoel Jacobsen's waves2Foam to Caelus. It is a suite of wave generation and absorption solvers and libraries. More information about waves2Foam is available at:
...
- There are two ways to setup the Caelus environment:
  _ If you use the CPL to run Caelus you do not need to do anything further to set up Caelus. The installer adds the CPL exe path to the system PATH
  _ If you to want use the previous method to run Caelus then type
