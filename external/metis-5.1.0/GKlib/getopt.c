...
{
  return gk_getopt_internal(__argc, __argv,__shortopts, NULL, NULL, 0);
}
...
*/
/*************************************************************************/
int gk_getopt_long(int __argc, char **__argv, char *__shortopts,
              struct gk_option *__longopts, int *__longind)
{
  return gk_getopt_internal (__argc, __argv, __shortopts, __longopts, __longind, 0);
}
...
*/
/*************************************************************************/
int gk_getopt_long_only (int __argc, char **__argv,
              char *__shortopts, struct gk_option *__longopts, int *__longind)
{
  return gk_getopt_internal(__argc, __argv, __shortopts, __longopts, __longind, 1);
}
