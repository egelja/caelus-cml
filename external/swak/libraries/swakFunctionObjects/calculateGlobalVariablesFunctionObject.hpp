...
#ifndef calculateGlobalVariablesFunctionObject_H
#define calculateGlobalVariablesFunctionObject_H
...
namespace CML
{
    typedef OutputFilterFunctionObject<calculateGlobalVariables> calculateGlobalVariablesFunctionObject;
}
