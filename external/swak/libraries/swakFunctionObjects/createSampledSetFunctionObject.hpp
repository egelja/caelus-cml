...
#ifndef createSampledSetFunctionObject_H
#define createSampledSetFunctionObject_H
...
namespace CML
{
    typedef OutputFilterFunctionObject<createSampledSet> createSampledSetFunctionObject;
}
