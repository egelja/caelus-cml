...
#ifndef solveTransportPDEFunctionObject_H
#define solveTransportPDEFunctionObject_H
...
namespace CML
{
    typedef OutputFilterFunctionObject<solveTransportPDE> solveTransportPDEFunctionObject;
}
