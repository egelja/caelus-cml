...
#define YY_DECL int parserSubsetlex(parserSubset::SubsetValueExpressionParser::semantic_type* yylval_param,parserSubset::location* yylloc,void *yyscanner,CML::SubsetValueExpressionDriver &driver,int& start_token,int& numberOfFunctionChars)
