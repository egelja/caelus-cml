...
const CML::scalar CML::edgeStats::edgeTol_ = 1E-3;



// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

CML::direction CML::edgeStats::getNormalDir
(
...
// Construct from mesh
CML::edgeStats::edgeStats(const polyMesh& mesh)
:
    mesh_(mesh),
    normalDir_(3)
{
...
CML::scalar CML::edgeStats::minLen(Ostream& os) const
{
    label nX = 0;
    label nY = 0;
    label nZ = 0;
