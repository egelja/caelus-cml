...
void CML::writeFuns::writeHeader
(
    std::ostream& os,
    const bool binary,
...
void CML::writeFuns::writeCellDataHeader
(
    std::ostream& os,
    const label nCells,
    const label nFields
...
void CML::writeFuns::writePointDataHeader
(
    std::ostream& os,
    const label nPoints,
    const label nFields
...
void CML::writeFuns::insert(const scalar src, DynamicList<floatScalar>& dest)
{
    dest.append(float(src));
}


void CML::writeFuns::insert(const vector& src, DynamicList<floatScalar>& dest)
{
...
void CML::writeFuns::insert(const tensor& src, DynamicList<floatScalar>& dest)
{
...
void CML::writeFuns::insert(const labelList& src, DynamicList<label>& dest)
{
    dest.append(src);
}
