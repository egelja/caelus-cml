...
CML::Rosenbrock12::Rosenbrock12(const ODESystem& ode, const dictionary& dict)
:
    ODESolver(ode, dict),
...
CML::scalar CML::Rosenbrock12::solve
(
    const scalar x0,
