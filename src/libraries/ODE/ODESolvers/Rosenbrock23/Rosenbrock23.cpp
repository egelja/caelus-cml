...
CML::Rosenbrock23::Rosenbrock23(const ODESystem& ode, const dictionary& dict)
:
    ODESolver(ode, dict),
...
CML::scalar CML::Rosenbrock23::solve
(
    const scalar x0,
