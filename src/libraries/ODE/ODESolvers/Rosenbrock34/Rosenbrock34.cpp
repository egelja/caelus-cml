...
CML::Rosenbrock34::Rosenbrock34(const ODESystem& ode, const dictionary& dict)
:
    ODESolver(ode, dict),
...
CML::scalar CML::Rosenbrock34::solve
(
    const scalar x0,
