...
CML::combustionModels::rhoCombustionModel::rhoCombustionModel
(
...
CML::combustionModels::rhoCombustionModel::rho() const
{
    return thermo_->rho();
}


bool CML::combustionModels::rhoCombustionModel::read()
{
