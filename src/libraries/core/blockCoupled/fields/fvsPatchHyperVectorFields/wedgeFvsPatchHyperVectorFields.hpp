...
#ifndef wedgeFvsPatchHyperVectorFields_HPP
#define wedgeFvsPatchHyperVectorFields_HPP

#include "wedgeFvsPatchHyperVectorFieldsFwd.hpp"
#include "wedgeFvsPatchField.hpp"
