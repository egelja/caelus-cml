...
#ifndef hyperVectorFieldsFwd_HPP
#define hyperVectorFieldsFwd_HPP
...
#define makeTypedef(Type, args...)      \
    ...
    forAllHyperVectorTypes(makeTypedef)

    forAllHyperTensorTypes(makeTypedef)
