...
Description
    hyperVector4 obtained from generic hyperVector.
...
#ifndef hyperVector4_HPP
#define hyperVector4_HPP
...
typedef hyperVector<scalar, 4> hyperVector4;

//- Specify data associated with hyperVector4 type is contiguous
template<>
inline bool contiguous<hyperVector4>()
{
    return true;
}
