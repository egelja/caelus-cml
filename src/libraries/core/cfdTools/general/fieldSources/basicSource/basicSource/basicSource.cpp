...
void CML::basicSource::setSelection(const dictionary& dict)
{
...
void CML::basicSource::setCellSet()
{
...
CML::autoPtr<CML::basicSource> CML::basicSource::New
(
    const word& name,
...
CML::label CML::basicSource::applyToField(const word& fieldName) const
{
...
void CML::basicSource::checkApplied() const
{
    forAll(applied_, i)
    {
        if (!applied_[i])
        {
            WarningIn("void CML::basicSource::checkApplied() const")
...
void CML::basicSource::correct(volScalarField& fld)
{
    // do nothing
}


void CML::basicSource::correct(volVectorField& fld)
{
    // do nothing
}


void CML::basicSource::correct(volSphericalTensorField& fld)
{
    // do nothing
}


void CML::basicSource::correct(volSymmTensorField& fld)
{
    // do nothing
}


void CML::basicSource::correct(volTensorField& fld)
{
    // do nothing
}


void CML::basicSource::addSup(fvMatrix<scalar>& eqn, const label fieldI)
{
    // do nothing
}


void CML::basicSource::addSup(fvMatrix<vector>& eqn, const label fieldI)
{
    // do nothing
}


void CML::basicSource::addSup
(
...
void CML::basicSource::addSup(fvMatrix<symmTensor>& eqn, const label fieldI)
{
    // do nothing
}


void CML::basicSource::addSup(fvMatrix<tensor>& eqn, const label fieldI)
{
    // do nothing
}


void CML::basicSource::setValue(fvMatrix<scalar>& eqn, const label fieldI)
{
    // do nothing
}


void CML::basicSource::setValue(fvMatrix<vector>& eqn, const label fieldI)
{
    // do nothing
}


void CML::basicSource::setValue
(
    fvMatrix<sphericalTensor>& eqn,
    const label fieldI
)
...
void CML::basicSource::setValue(fvMatrix<tensor>& eqn, const label fieldI)
{
    // do nothing
}
