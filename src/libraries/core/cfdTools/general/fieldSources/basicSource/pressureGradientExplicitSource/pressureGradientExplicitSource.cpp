...
void CML::pressureGradientExplicitSource::writeGradP() const
{
...
CML::pressureGradientExplicitSource::pressureGradientExplicitSource
(
    ...
    flowDir_(Ubar_/mag(Ubar_))
{
    ...
    if (fieldNames_.size() != 1)
    {
        FatalErrorIn
        (
            "CML::pressureGradientExplicitSource::"
            "pressureGradientExplicitSource"
            "("
                "onst word&, "
                "const word&, "
...
void CML::pressureGradientExplicitSource::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldI
)
...
void CML::pressureGradientExplicitSource::correct(volVectorField& U)
{
