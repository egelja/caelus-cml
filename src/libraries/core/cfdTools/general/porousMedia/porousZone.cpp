...
void CML::porousZone::adjustNegativeResistance(dimensionedVector& resist)
{
    ...
    if (maxCmpt < 0)
    {
        FatalErrorIn
        (
            "CML::porousZone::porousZone::adjustNegativeResistance"
            "(dimensionedVector&)"
...
void CML::porousZone::addResistance(fvVectorMatrix& UEqn) const
{
...
void CML::porousZone::addResistance
(
    fvVectorMatrix& UEqn,
...
void CML::porousZone::writeDict(Ostream& os, bool subDict) const
{
    if (subDict)
    {
...
CML::Ostream& CML::operator<<(Ostream& os, const porousZone& pz)
{
    pz.writeDict(os);
    return os;
}
