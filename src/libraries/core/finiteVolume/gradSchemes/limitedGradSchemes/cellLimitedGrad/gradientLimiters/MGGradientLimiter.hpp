...
Description
    ...
    To be used with the CML::fv::cellLimitedGrad limited gradient.  This
    limiter function is similar to CML::fv::gradientLimiters::DL
    but is a fit to obey the value and gradient constraints and avoids the
    problem of the limiter exceeding 1 present in the DL function.
    ...
    gradSchemes
    {
        ...
        limited cellLimited<MG> 1.5 Gauss linear 1;
    }
    \endverbatim
...
#ifndef MGGradientLimiter_HPP
#define MGGradientLimiter_HPP
