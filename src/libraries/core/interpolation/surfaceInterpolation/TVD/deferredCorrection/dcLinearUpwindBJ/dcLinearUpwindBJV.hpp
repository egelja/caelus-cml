...
#ifndef dcLinearUpwindBJV_H
#define dcLinearUpwindBJV_H
    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        dcLinearUpwindBJV(const dcLinearUpwindBJV&);

        //- Disallow default bitwise assignment
        void operator=(const dcLinearUpwindBJV&);


public:

    //- Runtime type information
    TypeName("dcLinearUpwindBJV");
