...
#ifndef dcLinearUpwindMCV_H
#define dcLinearUpwindMCV_H
    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        dcLinearUpwindMCV(const dcLinearUpwindMCV&);

        //- Disallow default bitwise assignment
        void operator=(const dcLinearUpwindMCV&);


public:

    //- Runtime type information
    TypeName("dcLinearUpwindMCV");
