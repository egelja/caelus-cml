...
#ifndef dcLinearUpwindVanAlbadaV_H
#define dcLinearUpwindVanAlbadaV_H
...
template<class Type>
class dcLinearUpwindVanAlbadaV
:
    public upwind<Type>
{
    // Private Data
    ...
    // Private Member Functions
        ...
        dcLinearUpwindVanAlbadaV(const dcLinearUpwindVanAlbadaV&);

        //- Disallow default bitwise assignment
        void operator=(const dcLinearUpwindVanAlbadaV&);


public:

    //- Runtime type information
    TypeName("dcLinearUpwindVanAlbadaV");


    // Constructors

        //- Construct from faceFlux
        dcLinearUpwindVanAlbadaV
        (
            const fvMesh& mesh,
