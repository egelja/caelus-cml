...
#ifndef linearUpwindDLV_H
#define linearUpwindDLV_H
    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        linearUpwindDLV(const linearUpwindDLV&);

        //- Disallow default bitwise assignment
        void operator=(const linearUpwindDLV&);


public:

    //- Runtime type information
    TypeName("linearUpwindDLV");
    ...
    // Constructors
            ...
            )
        {
            if (!schemeData.eof())
            {
                IOWarningIn
                (
                    "linearUpwindDLV(const fvMesh&, Istream&)",
                    schemeData
