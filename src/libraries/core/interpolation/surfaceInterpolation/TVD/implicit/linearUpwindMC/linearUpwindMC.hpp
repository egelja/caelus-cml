...
#ifndef linearUpwindMC_H
#define linearUpwindMC_H
    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        linearUpwindMC(const linearUpwindMC&);

        //- Disallow default bitwise assignment
        void operator=(const linearUpwindMC&);


public:

    //- Runtime type information
    TypeName("linearUpwindMC");
    ...
    // Constructors
            ...
            )
        {
            if (!schemeData.eof())
            {
                IOWarningIn("linearUpwindMC(const fvMesh&, Istream&)", schemeData)
