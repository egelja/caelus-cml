...
#include "linearUpwindMinmodV.hpp"
#include "fvMesh.hpp"
...
CML::linearUpwindMinmodV<Type>::correction
(
...
) const
{
    ...
    (
        ...
        (
            IOobject
            (
                "linearUpwindMinmodV::correction(" + vf.name() + ')',
                mesh.time().timeName(),
                mesh,
                IOobject::NO_READ,
                IOobject::NO_WRITE,
...
namespace CML
{
    makelimitedSurfaceInterpolationTypeScheme(linearUpwindMinmodV, vector)
}
