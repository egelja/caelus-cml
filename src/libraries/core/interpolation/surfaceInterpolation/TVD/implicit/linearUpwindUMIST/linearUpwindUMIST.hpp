    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        linearUpwindUMIST(const linearUpwindUMIST&);

        //- Disallow default bitwise assignment
        void operator=(const linearUpwindUMIST&);
...
public:
    ...
    // Constructors
            ...
            )
        {
            if (!schemeData.eof())
            {
                IOWarningIn("linearUpwindUMIST(const fvMesh&, Istream&)", schemeData)
            ...
            )
        {
            ...
            if (!schemeData.eof())
            {
                IOWarningIn
                (
                    "linearUpwindUMIST(const fvMesh&, "
