    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        linearUpwindVanAlbada(const linearUpwindVanAlbada&);

        //- Disallow default bitwise assignment
        void operator=(const linearUpwindVanAlbada&);
...
public:
    ...
    // Constructors
            ...
            )
        {
            if (!schemeData.eof())
            {
                IOWarningIn("linearUpwindVanAlbada(const fvMesh&, Istream&)", schemeData)
            ...
            )
        {
            ...
            if (!schemeData.eof())
            {
                IOWarningIn
                (
                    "linearUpwindVanAlbada(const fvMesh&, "
