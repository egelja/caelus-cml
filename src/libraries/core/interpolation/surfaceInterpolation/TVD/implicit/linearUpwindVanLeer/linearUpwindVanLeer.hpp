    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        linearUpwindVanLeer(const linearUpwindVanLeer&);

        //- Disallow default bitwise assignment
        void operator=(const linearUpwindVanLeer&);
...
public:
    ...
    // Constructors
            ...
            )
        {
            if (!schemeData.eof())
            {
                IOWarningIn("linearUpwindVanLeer(const fvMesh&, Istream&)", schemeData)
            ...
            )
        {
            ...
            if (!schemeData.eof())
            {
                IOWarningIn
                (
                    "linearUpwindVanLeer(const fvMesh&, "
