...
\*---------------------------------------------------------------------------*/
#ifndef bjFluxLimiter_HPP_
#define bjFluxLimiter_HPP_

#define makeBJFluxLimiter(classType)                                           \
template<class Type>                                                           \
CML::scalar                                                                    \
CML::classType##BJ<Type>::fluxLimiter(CML::scalar const r) const               \
{                                                                              \
    return CML::scalar                                                         \
    (                                                                          \
        0.5*(r+1)*max                                                          \
