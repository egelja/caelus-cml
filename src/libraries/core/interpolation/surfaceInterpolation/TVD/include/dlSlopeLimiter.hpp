...
\*---------------------------------------------------------------------------*/
#ifndef dlSlopeLimiter_HPP_
#define dlSlopeLimiter_HPP_

#define makeDLSlopeLimiter(classType)                                          \
template<class Type>                                                           \
CML::scalar                                                                    \
CML::classType##DL<Type>::slopeLimiter(CML::scalar const r) const              \
{                                                                              \
    return CML::scalar                                                         \
    (                                                                          \
        max(r*(r+2)/(r*(r+1)+2+VSMALL), 0)                                     \
    );                                                                         \
}                                                                              
#endif
