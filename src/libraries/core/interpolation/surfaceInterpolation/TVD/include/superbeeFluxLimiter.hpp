...
\*---------------------------------------------------------------------------*/
#ifndef superbeeFluxLimiter_HPP_
#define superbeeFluxLimiter_HPP_

#define makeSuperbeeFluxLimiter(classType)                                     \
template<class Type>                                                           \
CML::scalar                                                                    \
CML::classType##Superbee<Type>::fluxLimiter(CML::scalar const r) const         \
{                                                                              \
    return CML::scalar                                                         \
    (                                                                          \
        max(min(min(max(1,r),2),2*r),0)                                        \
    );                                                                         \
}                                                                              
#endif
