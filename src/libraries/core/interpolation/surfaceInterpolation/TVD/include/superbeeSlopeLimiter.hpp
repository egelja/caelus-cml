...
\*---------------------------------------------------------------------------*/
#ifndef superbeeSlopeLimiter_HPP_
#define superbeeSlopeLimiter_HPP_

#define makeSuperbeeSlopeLimiter(classType)                                    \
template<class Type>                                                           \
CML::scalar                                                                    \
CML::classType##Superbee<Type>::slopeLimiter(CML::scalar const r) const        \
{                                                                              \
    return CML::scalar                                                         \
    (                                                                          \
        max                                                                    \
