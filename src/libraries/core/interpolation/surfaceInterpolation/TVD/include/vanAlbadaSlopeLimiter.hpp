...
\*---------------------------------------------------------------------------*/
#ifndef vanAlbadaSlopeLimiter_HPP_
#define vanAlbadaSlopeLimiter_HPP_

#define makeVanAlbadaSlopeLimiter(classType)                                   \
template<class Type>                                                           \
CML::scalar                                                                    \
CML::classType##VanAlbada<Type>::slopeLimiter(CML::scalar const r) const       \
{                                                                              \
    return CML::scalar                                                         \
    (                                                                          \
        max(0,2/(r+stabilise(1/r,VSMALL)))                                     \
    );                                                                         \
}                                                                              
#endif
