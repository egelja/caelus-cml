...
\*---------------------------------------------------------------------------*/
#ifndef vanLeerFluxLimiter_HPP_
#define vanLeerFluxLimiter_HPP_

#define makeVanLeerFluxLimiter(classType)                                      \
template<class Type>                                                           \
CML::scalar                                                                    \
CML::classType##VanLeer<Type>::fluxLimiter(CML::scalar const r) const          \
{                                                                              \
    return CML::scalar                                                         \
    (                                                                          \
        max(0,2*r/(r+1+VSMALL))                                                \
    );                                                                         \
}                                                                              
#endif
