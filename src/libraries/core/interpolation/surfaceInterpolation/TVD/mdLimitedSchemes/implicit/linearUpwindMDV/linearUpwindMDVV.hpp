...
#ifndef linearUpwindMDVV_HPP
#define linearUpwindMDVV_HPP
    ...
    public upwind<Type>
{
    ...
    // Private Member Functions
        ...
        linearUpwindMDVV(const linearUpwindMDVV&);

        //- Disallow default bitwise assignment
        void operator=(const linearUpwindMDVV&);


public:

    //- Runtime type information
    TypeName("linearUpwindMDVV");
        ...
        )
    {
        if (!schemeData.eof())
        {
            IOWarningIn("linearUpwindMDVV(const fvMesh&, Istream&)", schemeData)
