 ...
 *
 * \sa xferCopyTo, xferMove, xferMoveTo, xferTmp and CML::Xfer
*/
template<class T>
 ...
 *
 * \sa xferCopy, xferCopyTo, xferMoveTo, xferTmp and CML::Xfer
*/
template<class T>
 ...
 * Construct by transferring the contents of the \a arg
 *
 * \sa xferCopy, xferCopyTo, xferMove, xferMoveTo and CML::Xfer
*/
template<class T>
inline Xfer<T> xferTmp(CML::tmp<T>&);
 ...
 *
 * \sa xferCopy, xferMove, xferMoveTo, xferTmp and CML::Xfer
*/
 ...
 * \endcode
 *
 * \sa xferCopy, xferCopyTo, xferMove, xferTmp and CML::Xfer
*/
template<class To, class From>
