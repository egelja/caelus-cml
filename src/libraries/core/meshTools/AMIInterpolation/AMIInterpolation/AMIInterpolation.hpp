...
template<class SourcePatch, class TargetPatch>
void CML::AMIInterpolation<SourcePatch, TargetPatch>::writeIntersectionOBJ
(
    const scalar area,
    const face& f1,
    const face& f2,
...
template<class SourcePatch, class TargetPatch>
void CML::AMIInterpolation<SourcePatch, TargetPatch>::checkPatches
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch
)
...
template<class SourcePatch, class TargetPatch>
void CML::AMIInterpolation<SourcePatch, TargetPatch>::resetTree
(
    const primitivePatch& tgtPatch
)
{
...
) const
{
    ...
    if (nMiss > 0)
    {
        FatalErrorIn
        (
            "void CML::projectPointsToSurface"
            "("
...
template<class SourcePatch, class TargetPatch>
CML::label CML::AMIInterpolation<SourcePatch, TargetPatch>::findTargetFace
(
    const label srcFaceI,
    const primitivePatch& srcPatch
) const
...
template<class SourcePatch, class TargetPatch>
void CML::AMIInterpolation<SourcePatch, TargetPatch>::appendNbrFaces
(
    const label faceI,
    const primitivePatch& patch,
    const DynamicList<label>& visitedFaces,
...
template<class SourcePatch, class TargetPatch>
bool CML::AMIInterpolation<SourcePatch, TargetPatch>::processSourceFace
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
    const label srcFaceI,
...
template<class SourcePatch, class TargetPatch>
void CML::AMIInterpolation<SourcePatch, TargetPatch>::setNextFaces
(
    label& srcFaceI,
    label& tgtFaceI,
    const primitivePatch& srcPatch0,
...
template<class SourcePatch, class TargetPatch>
CML::scalar CML::AMIInterpolation<SourcePatch, TargetPatch>::interArea
(
    const label srcFaceI,
    const label tgtFaceI,
    const primitivePatch& srcPatch,
...
template<class SourcePatch, class TargetPatch>
void CML::AMIInterpolation<SourcePatch, TargetPatch>::calcAddressing
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
    label srcFaceI,
