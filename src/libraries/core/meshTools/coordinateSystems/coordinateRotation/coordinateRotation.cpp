...
void CML::coordinateRotation::calcTransform
(
    const vector& axis1,
    const vector& axis2,
...
CML::coordinateRotation::coordinateRotation()
:
...
void CML::coordinateRotation::clear()
{
...
void CML::coordinateRotation::operator=(const dictionary& rhs)
{
    if (debug)
    {
