...
#include "parabolicCylindricalCS.hpp"
...
CML::parabolicCylindricalCS::parabolicCylindricalCS()
:
    coordinateSystem()
{}
...
CML::vector CML::parabolicCylindricalCS::localToGlobal
(
    const vector& local,
    bool translate
) const
...
CML::tmp<CML::vectorField> CML::parabolicCylindricalCS::localToGlobal
(
...
CML::vector CML::parabolicCylindricalCS::globalToLocal
(
    const vector& global,
    bool translate
) const
...
CML::tmp<CML::vectorField> CML::parabolicCylindricalCS::globalToLocal
(
