...
defineTypeNameAndDebug(CML::treeDataTriSurface, 0);
...
// CML::scalar CML::treeDataTriSurface::nearestCoords
// (
//     const point& base,
//     const point& E0,
//     const point& E1,
...
//     const scalar f = D & D;
//     return CML::mag(a*s*s + 2*b*s*t + c*t*t + 2*d*s + 2*e*t + f);
// }
...
CML::treeDataTriSurface::treeDataTriSurface
(
...
CML::pointField CML::treeDataTriSurface::shapePoints() const
{
...
CML::label CML::treeDataTriSurface::getVolumeType
(
...
bool CML::treeDataTriSurface::overlaps
(
    const label index,
...
// nearestPoint.
void CML::treeDataTriSurface::findNearest
(
...
bool CML::treeDataTriSurface::intersects
(
    const label index,
    const point& start,
    const point& end,
