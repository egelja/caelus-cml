...
void CML::regionSplit::transferCoupledFaceRegion
(
    const label faceI,
...
void CML::regionSplit::fillSeedMask
(
...
CML::label CML::regionSplit::calcRegionSplit
(
...
CML::regionSplit::regionSplit(const polyMesh& mesh)
:
