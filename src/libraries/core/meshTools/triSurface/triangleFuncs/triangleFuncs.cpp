...
void CML::triangleFuncs::setIntersection
(
...
void CML::triangleFuncs::selectPt
(
    const bool select0,
    const point& p0,
    const point& p1,
...
bool CML::triangleFuncs::intersectAxesBundle
(
    const point& V0,
    const point& V10,
    const point& V20,
...
)
{
    ...
    //          V20:(0 0 -1.678573)
    //          i0:0
    if (localScale < VSMALL || CML::mag(det)/localScale < SMALL)
    {
...
bool CML::triangleFuncs::intersectBb
(
    const point& p0,
    const point& p1,
    const point& p2,
...
//// any of the faces of bb intersect triangle.
//// Note: so returns false if triangle inside bb.
//bool CML::triangleFuncs::intersectBbExact
//(
//    const point& p0,
//    const point& p1,
//    const point& p2,
...
bool CML::triangleFuncs::intersect
(
    const point& va0,
    const point& va10,
    const point& va20,
...
)
{
    ...
    scalar tol = SMALL*CML::sqrt(magArea);
