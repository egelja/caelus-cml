...
defineTypeNameAndDebug(CML::mapDistribute, 0);
...
CML::List<CML::labelPair> CML::mapDistribute::schedule
(
...
const CML::List<CML::labelPair>& CML::mapDistribute::schedule() const
{
...
void CML::mapDistribute::checkReceivedSize
(
    const label procI,
...
void CML::mapDistribute::calcCompactAddressing
(
...
void CML::mapDistribute::exchangeAddressing
(
    const int tag,
    const globalIndex& globalNumbering,
    labelList& elements,
...
CML::label CML::mapDistribute::renumber
(
    const globalIndex& globalNumbering,
...
void CML::mapDistribute::compact(const boolList& elemIsUsed, const int tag)
{
...
void CML::mapDistribute::operator=(const mapDistribute& rhs)
{
    ...
    if (this == &rhs)
    {
        FatalErrorIn
        (
            "CML::mapDistribute::operator=(const CML::mapDistribute&)"
