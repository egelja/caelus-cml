...
inline CML::line<Point, PointRef>::line(const Point& start, const Point& end)
:
    a_(start),
    b_(end)
{}
...
template<class Point, class PointRef>
inline CML::line<Point, PointRef>::line
(
...
template<class Point, class PointRef>
inline CML::line<Point, PointRef>::line(Istream& is)
{
    is  >> *this;
}
...
template<class Point, class PointRef>
inline PointRef CML::line<Point, PointRef>::start() const
{
    return a_;
}

template<class Point, class PointRef>
inline PointRef CML::line<Point, PointRef>::end() const
{
    return b_;
}
...
template<class Point, class PointRef>
inline Point CML::line<Point, PointRef>::centre() const
{
    return 0.5*(a_ + b_);
}
...
template<class Point, class PointRef>
inline CML::scalar CML::line<Point, PointRef>::mag() const
{
    return ::CML::mag(vec());
}
...
template<class Point, class PointRef>
inline Point CML::line<Point, PointRef>::vec() const
{
    return b_ - a_;
}
...
template<class Point, class PointRef>
CML::PointHit<Point> CML::line<Point, PointRef>::nearestDist
(
    const Point& p
) const
{
    ...
    if (c1 <= 0)
    {
        return PointHit<Point>(false, a_, CML::mag(p - a_), true);
    }
    ...
    if (c2 <= c1)
    {
        return PointHit<Point>(false, b_, CML::mag(p - b_), true);
    }
    ...
    return PointHit<Point>(true, pb, CML::mag(p - pb), false);
}


template<class Point, class PointRef>
CML::scalar CML::line<Point, PointRef>::nearestDist
(
