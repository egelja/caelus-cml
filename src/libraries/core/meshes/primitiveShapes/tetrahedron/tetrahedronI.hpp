...
template<class Point, class PointRef>
inline CML::tetrahedron<Point, PointRef>::tetrahedron(Istream& is)
{
    is  >> *this;
}
...
template<class Point, class PointRef>
inline const Point& CML::tetrahedron<Point, PointRef>::b() const
{
    return b_;
}
...
template<class Point, class PointRef>
inline const Point& CML::tetrahedron<Point, PointRef>::c() const
{
    return c_;
}
...
template<class Point, class PointRef>
inline const Point& CML::tetrahedron<Point, PointRef>::d() const
{
    return d_;
}
...
template<class Point, class PointRef>
inline Point CML::tetrahedron<Point, PointRef>::centre() const
{
...
template<class Point, class PointRef>
inline CML::scalar CML::tetrahedron<Point, PointRef>::mag() const
{
...
template<class Point, class PointRef>
inline Point CML::tetrahedron<Point, PointRef>::circumCentre() const
{
    vector a = b_ - a_;
    vector b = c_ - a_;
    vector c = d_ - a_;
...
template<class Point, class PointRef>
inline CML::scalar CML::tetrahedron<Point, PointRef>::circumRadius() const
{
    vector a = b_ - a_;
    vector b = c_ - a_;
    vector c = d_ - a_;
    ...
    return CML::mag(0.5*(a + num/denom));
}


template<class Point, class PointRef>
inline CML::scalar CML::tetrahedron<Point, PointRef>::quality() const
{
    return
        mag()
       /(
...
template<class Point, class PointRef>
inline CML::pointHit CML::tetrahedron<Point, PointRef>::nearestPoint
(
    const point& p
) const
{
...
template<class Point, class PointRef>
bool CML::tetrahedron<Point, PointRef>::inside(const point& pt) const
{
