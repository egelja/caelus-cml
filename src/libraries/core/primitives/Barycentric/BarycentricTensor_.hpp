...
public:
    ...
    // Constructors
        ...
        BarycentricTensor(const CML::zero);
...
template<class Cmpt>
inline CML::BarycentricTensor<Cmpt>::BarycentricTensor()
{}


template<class Cmpt>
inline CML::BarycentricTensor<Cmpt>::BarycentricTensor(const CML::zero)
:
...
template<class Cmpt>
inline CML::Barycentric<Cmpt> CML::BarycentricTensor<Cmpt>::x() const
{
    return
        Barycentric<Cmpt>
        (
...
template<class Cmpt>
inline CML::Barycentric<Cmpt> CML::BarycentricTensor<Cmpt>::y() const
{
    return
        Barycentric<Cmpt>
        (
...
template<class Cmpt>
inline CML::Barycentric<Cmpt> CML::BarycentricTensor<Cmpt>::z() const
{
    return
        Barycentric<Cmpt>
        (
...
template<class Cmpt>
inline CML::Vector<Cmpt> CML::BarycentricTensor<Cmpt>::a() const
{
...
template<class Cmpt>
inline CML::Vector<Cmpt> CML::BarycentricTensor<Cmpt>::b() const
{
...
template<class Cmpt>
inline CML::Vector<Cmpt> CML::BarycentricTensor<Cmpt>::c() const
{
...
template<class Cmpt>
inline CML::Vector<Cmpt> CML::BarycentricTensor<Cmpt>::d() const
{
