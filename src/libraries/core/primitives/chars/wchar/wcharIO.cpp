...
CML::Ostream& CML::operator<<(Ostream& os, const wchar_t wc)
{
    if (!(wc & ~0x0000007F))
    {
...
CML::Ostream& CML::operator<<(Ostream& os, const wchar_t* wstr)
{
    if (wstr)
    {
...
CML::Ostream& CML::operator<<(Ostream& os, const std::wstring& wstr)
{
    for
    (
