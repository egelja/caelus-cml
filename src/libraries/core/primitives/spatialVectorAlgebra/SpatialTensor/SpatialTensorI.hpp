...
template<class Cmpt>
inline CML::SpatialTensor<Cmpt>::SpatialTensor()
{}


template<class Cmpt>
inline CML::SpatialTensor<Cmpt>::SpatialTensor(const CML::zero)
:
...
template<class Cmpt>
inline CML::SpatialTensor<Cmpt>::SpatialTensor(Istream& is)
:
...
template<class Cmpt>
inline CML::SpatialTensor<Cmpt> operator^
(
