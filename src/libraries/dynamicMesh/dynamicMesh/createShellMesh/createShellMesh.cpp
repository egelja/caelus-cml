...
// Synchronise edges
void CML::createShellMesh::syncEdges
(
...
void CML::createShellMesh::calcPointRegions
(
    const globalMeshData& globalData,
...
CML::createShellMesh::createShellMesh
(
    const primitiveFacePatch& patch,
...
void CML::createShellMesh::setRefinement
(
...
void CML::createShellMesh::updateMesh(const mapPolyMesh& map)
{
