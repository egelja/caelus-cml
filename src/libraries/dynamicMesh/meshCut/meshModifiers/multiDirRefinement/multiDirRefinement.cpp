...
defineTypeNameAndDebug(CML::multiDirRefinement, 0);
...
void CML::multiDirRefinement::addCells
(
...
// original cell.
void CML::multiDirRefinement::update
(
    const Map<label>& splitMap,
    vectorField& field
)
...
CML::labelList CML::multiDirRefinement::splitOffHex(const primitiveMesh& mesh)
{
...
void CML::multiDirRefinement::refineHex8
(
    polyMesh& mesh,
...
void CML::multiDirRefinement::refineAllDirs
(
    polyMesh& mesh,
...
void CML::multiDirRefinement::refineFromDict
(
    polyMesh& mesh,
    List<vectorField>& cellDirections,
...
CML::multiDirRefinement::multiDirRefinement
(
    polyMesh& mesh,
