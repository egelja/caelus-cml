...
inline CML::symmTensor CML::RBD::rigidBodyInertia::Ioc
(
    const scalar m,
    const vector& c
)
{
    return m*(CML::I*magSqr(c) - sqr(c));
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

inline CML::RBD::rigidBodyInertia::rigidBodyInertia()
:
    m_(0),
    c_(Zero),
    Ic_(Zero)
...
inline CML::RBD::rigidBodyInertia::rigidBodyInertia(const dictionary& dict)
:
...
inline CML::RBD::rigidBodyInertia::rigidBodyInertia(const spatialTensor& st)
:
    m_(st(3, 3)),
...
inline CML::RBD::rigidBodyInertia::rigidBodyInertia(Istream& is)
:
    m_(readScalar(is)),
    c_(is),
    Ic_(is)
...
inline CML::scalar CML::RBD::rigidBodyInertia::m() const
{
    return m_;
}

inline const CML::vector& CML::RBD::rigidBodyInertia::c() const
{
    return c_;
}

inline const CML::symmTensor& CML::RBD::rigidBodyInertia::Ic() const
{
    return Ic_;
}

inline CML::symmTensor CML::RBD::rigidBodyInertia::Ioc() const
{
    return Ioc(m_, c_);
}

inline CML::symmTensor CML::RBD::rigidBodyInertia::Icc(const vector& c) const
{
    return Ioc(m_, c - c_);
}

inline CML::symmTensor CML::RBD::rigidBodyInertia::Io() const
{
    return Ic_ + Ioc();
}
...
inline CML::RBD::rigidBodyInertia::operator spatialTensor() const
{
    tensor mcStar(m_*(*c_));
...
inline CML::Istream& CML::RBD::operator>>
(
    Istream& is,
...
inline CML::Ostream& CML::RBD::operator<<
(
    Ostream& os,
...
inline CML::scalar CML::RBD::rigidBodyInertia::kineticEnergy
(
...
inline void CML::RBD::rigidBodyInertia::operator+=
(
    const rigidBodyInertia& rbi
)
{
