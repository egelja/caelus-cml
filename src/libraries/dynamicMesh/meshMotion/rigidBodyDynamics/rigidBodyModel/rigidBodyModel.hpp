...
#ifndef RBD_rigidBodyModel_HPP
#define RBD_rigidBodyModel_HPP
...
public:
    ...
    // Member Functions
        ...
        //- Return const access to Time
        inline const Time& time() const;
    
		//- Return the number of restraints in the model (restraints().size())
        inline label nRests() const;
		
        //- Return the number of bodies in the model (bodies().size())
        inline label nBodies() const;
        
        //- Return the list of the restraints in the model
        inline const PtrList<restraint>& restraints() const;
