...
defineTypeNameAndDebug(CML::combineFaces, 0);
...
bool CML::combineFaces::convexFace
(
...
bool CML::combineFaces::validFace
(
    const scalar minConcaveCos,
...
void CML::combineFaces::regioniseFaces
(
    const scalar minCos,
    const label cellI,
...
bool CML::combineFaces::faceNeighboursValid
(
    const label cellI,
...
CML::labelListList CML::combineFaces::getMergeSets
(
...
CML::face CML::combineFaces::getOutsideFace
(
...
void CML::combineFaces::setRefinement
(
...
void CML::combineFaces::updateMesh(const mapPolyMesh& map)
{
    if (undoable_)
    {
...
void CML::combineFaces::setUnrefinement
(
