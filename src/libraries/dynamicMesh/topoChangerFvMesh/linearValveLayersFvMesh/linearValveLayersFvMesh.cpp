...
#include "linearValveLayersFvMesh.hpp"
#include "Time.hpp"
...
void CML::linearValveLayersFvMesh::addZonesAndModifiers()
{
...
void CML::linearValveLayersFvMesh::makeLayersLive()
{
...
void CML::linearValveLayersFvMesh::makeSlidersLive()
{
    const polyTopoChanger& topoChanges = topoChanger_;
...
bool CML::linearValveLayersFvMesh::attached() const
{
    const polyTopoChanger& topoChanges = topoChanger_;
...
CML::tmp<CML::pointField> CML::linearValveLayersFvMesh::newPoints() const
{
...
CML::linearValveLayersFvMesh::linearValveLayersFvMesh(const IOobject& io)
:
...
CML::linearValveLayersFvMesh::~linearValveLayersFvMesh()
{}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void CML::linearValveLayersFvMesh::update()
{
