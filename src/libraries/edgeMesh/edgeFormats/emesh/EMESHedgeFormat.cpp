...
CML::fileFormats::EMESHedgeFormat::EMESHedgeFormat
(
...
bool CML::fileFormats::EMESHedgeFormat::read
(
    const fileName& filename
)
{
...
CML::Ostream& CML::fileFormats::EMESHedgeFormat::write
(
    Ostream& os,
...
void CML::fileFormats::EMESHedgeFormat::write
(
    const fileName& filename,
    const edgeMesh& mesh
)
