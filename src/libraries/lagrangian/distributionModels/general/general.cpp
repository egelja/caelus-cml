...
CML::distributionModels::general::general
(
...
CML::distributionModels::general::general(const general& p)
:
    distributionModel(p),
    xy_(p.xy_),
...
CML::scalar CML::distributionModels::general::sample() const
{
...
CML::scalar CML::distributionModels::general::minValue() const
{
    return minValue_;
}
