...
CML::patchInjectionBase::patchInjectionBase
(
    const polyMesh& mesh,
...
CML::patchInjectionBase::patchInjectionBase(const patchInjectionBase& pib)
:
...
void CML::patchInjectionBase::updateMesh(const polyMesh& mesh)
{
...
void CML::patchInjectionBase::setPositionAndCell
(
    const fvMesh& mesh,
    Random& rnd,
    vector& position,
