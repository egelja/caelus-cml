...
//void CML::wallBoundedParticle::checkInside() const
//{
...
//
//
//void CML::wallBoundedParticle::checkOnEdge() const
//{
...
//
//
//void CML::wallBoundedParticle::checkOnTriangle(const point& p)
//const
//{
...
// diagEdge_)
CML::edge CML::wallBoundedParticle::currentEdge() const
{
    ...
    const CML::face& f = mesh_.faces()[tetFace()];
...
void CML::wallBoundedParticle::crossEdgeConnectedFace
(
    const edge& meshEdge
)
{
...
void CML::wallBoundedParticle::crossDiagonalEdge()
{
    if (diagEdge_ == -1)
    {
...
CML::scalar CML::wallBoundedParticle::trackFaceTri
(
...
bool CML::wallBoundedParticle::isTriAlongTrack
(
...
CML::wallBoundedParticle::wallBoundedParticle
(
    const polyMesh& mesh,
...
void CML::wallBoundedParticle::write(Ostream& os, bool writeFields) const
{
