...
#include "wallBoundedStreamLine.hpp"
#include "fvMesh.hpp"
...
#include "meshSearchMeshObject.hpp"
#include "faceSet.hpp"
...
CML::wallBoundedStreamLine::wallPatch() const
{
...
CML::tetIndices CML::wallBoundedStreamLine::findNearestTet
(
...
void CML::wallBoundedStreamLine::track()
{
...
CML::wallBoundedStreamLine::wallBoundedStreamLine
(
    const word& name,
...
void CML::wallBoundedStreamLine::read(const dictionary& dict)
{
    if (active_)
    {
        //dict_ = dict;
...
void CML::wallBoundedStreamLine::execute()
{}


void CML::wallBoundedStreamLine::end()
{}


void CML::wallBoundedStreamLine::timeSet()
{}


void CML::wallBoundedStreamLine::write()
{
    if (active_)
    {
        const Time& runTime = obr_.time();
...
void CML::wallBoundedStreamLine::updateMesh(const mapPolyMesh&)
{
    read(dict_);
}


void CML::wallBoundedStreamLine::movePoints(const pointField&)
{
...
//void CML::wallBoundedStreamLine::readUpdate
