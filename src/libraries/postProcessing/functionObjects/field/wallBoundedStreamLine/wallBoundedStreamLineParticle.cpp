...
CML::vector CML::wallBoundedStreamLineParticle::interpolateFields
(
...
)
{
    ...
    (
     ...
     || magSqr(sampledPositions_.last()-position) > CML::sqr(SMALL)
    )
    {
        // Store the location
...
CML::vector CML::wallBoundedStreamLineParticle::sample
(
    trackingData& td
)
{
...
CML::wallBoundedStreamLineParticle::wallBoundedStreamLineParticle
(
    const polyMesh& mesh,
...
bool CML::wallBoundedStreamLineParticle::move
(
    trackingData& td,
...
void CML::wallBoundedStreamLineParticle::readFields
(
...
void CML::wallBoundedStreamLineParticle::writeFields
(
