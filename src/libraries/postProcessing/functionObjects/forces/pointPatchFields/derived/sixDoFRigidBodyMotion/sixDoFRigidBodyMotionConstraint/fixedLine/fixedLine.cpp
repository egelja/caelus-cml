...
CML::sixDoFRigidBodyMotionConstraints::fixedLine::fixedLine
(
...
bool CML::sixDoFRigidBodyMotionConstraints::fixedLine::constrain
(
...
bool CML::sixDoFRigidBodyMotionConstraints::fixedLine::read
(
    const dictionary& sDoFRBMCDict
)
{
    ...
    else
    {
        FatalErrorIn
        (
            "CML::sixDoFRigidBodyMotionConstraints::fixedLine::read"
            "("
                "const dictionary& sDoFRBMCDict"
            ")"
        )
...
void CML::sixDoFRigidBodyMotionConstraints::fixedLine::write
(
    Ostream& os
) const
{
