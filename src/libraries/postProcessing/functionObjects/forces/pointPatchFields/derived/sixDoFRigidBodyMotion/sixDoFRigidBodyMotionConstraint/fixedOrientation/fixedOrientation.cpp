...
CML::sixDoFRigidBodyMotionConstraints::fixedOrientation::fixedOrientation
(
...
bool CML::sixDoFRigidBodyMotionConstraints::fixedOrientation::constrain
(
...
bool CML::sixDoFRigidBodyMotionConstraints::fixedOrientation::read
(
    const dictionary& sDoFRBMCDict
)
{
...
void CML::sixDoFRigidBodyMotionConstraints::fixedOrientation::write
(
    Ostream& os
) const
{
