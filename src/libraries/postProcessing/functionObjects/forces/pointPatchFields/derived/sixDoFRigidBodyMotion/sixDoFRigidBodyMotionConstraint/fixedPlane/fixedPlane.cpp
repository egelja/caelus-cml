...
CML::sixDoFRigidBodyMotionConstraints::fixedPlane::fixedPlane
(
...
bool CML::sixDoFRigidBodyMotionConstraints::fixedPlane::constrain
(
...
bool CML::sixDoFRigidBodyMotionConstraints::fixedPlane::read
(
    const dictionary& sDoFRBMCDict
)
{
...
void CML::sixDoFRigidBodyMotionConstraints::fixedPlane::write
(
    Ostream& os
) const
{
