...
#include "sphericalAngularSpring.hpp"
...
CML::sixDoFRigidBodyMotionRestraints::sphericalAngularSpring::
sphericalAngularSpring
(
...
void
CML::sixDoFRigidBodyMotionRestraints::sphericalAngularSpring::restrain
(
...
bool CML::sixDoFRigidBodyMotionRestraints::sphericalAngularSpring::read
(
    const dictionary& sDoFRBMRDict
)
{
...
void CML::sixDoFRigidBodyMotionRestraints::sphericalAngularSpring::write
(
    Ostream& os
) const
{
