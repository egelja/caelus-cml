...
#include "tabulatedAxialAngularSpring.hpp"
...
CML::sixDoFRigidBodyMotionRestraints::tabulatedAxialAngularSpring::
tabulatedAxialAngularSpring
(
...
void
CML::sixDoFRigidBodyMotionRestraints::tabulatedAxialAngularSpring::restrain
(
...
bool CML::sixDoFRigidBodyMotionRestraints::tabulatedAxialAngularSpring::read
(
    const dictionary& sDoFRBMRDict
)
{
...
void CML::sixDoFRigidBodyMotionRestraints::tabulatedAxialAngularSpring::write
(
    Ostream& os
) const
{
