...
Class
    CML::sixDoFRigidBodyMotionState
...
SourceFiles
    sixDoFRigidBodyMotionStateI.hpp
    sixDoFRigidBodyMotionState.cpp
    sixDoFRigidBodyMotionStateIO.cpp
...
#include "sixDoFRigidBodyMotionStateI.hpp"
