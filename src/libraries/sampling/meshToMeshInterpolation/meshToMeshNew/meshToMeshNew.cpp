...
namespace CML
{
    ...
    <
        CML::meshToMeshNew::interpolationMethod,
        2
    >::names[] =
    {
        "map",
...
CML::scalar CML::meshToMeshNew::tolerance_ = 1e-6;

void CML::meshToMeshNew::writeConnectivity
(
    const polyMesh& src,
    const polyMesh& tgt,
...
CML::labelList CML::meshToMeshNew::maskCells
(
    const polyMesh& src,
    const polyMesh& tgt
) const
...
bool CML::meshToMeshNew::findInitialSeeds
(
    const polyMesh& src,
    const polyMesh& tgt,
...
void CML::meshToMeshNew::appendToDirectSeeds
(
    const polyMesh& src,
    const polyMesh& tgt,
    boolList& mapFlag,
...
void CML::meshToMeshNew::calcDirect
(
    const polyMesh& src,
    const polyMesh& tgt,
...
void CML::meshToMeshNew::normaliseWeights
(
...
void CML::meshToMeshNew::appendNbrTgtCells
(
...
void CML::meshToMeshNew::setNextCells
(
    label& startSeedI,
    label& srcCellI,
    label& tgtCellI,
...
bool CML::meshToMeshNew::intersect
(
    const polyMesh& src,
    const polyMesh& tgt,
...
CML::scalar CML::meshToMeshNew::interVol
(
    const polyMesh& src,
    const polyMesh& tgt,
    const label srcCellI,
...
void CML::meshToMeshNew::calcIndirect
(
    const polyMesh& src,
    const polyMesh& tgt,
    const label srcSeedI,
...
void CML::meshToMeshNew::calcAddressing
(
    const polyMesh& src,
    const polyMesh& tgt
)
...
CML::meshToMeshNew::meshToMeshNew
(
    const polyMesh& src,
    const polyMesh& tgt,
