...
template<class MixtureType>
void CML::ePsiThermo<MixtureType>::calculate()
{
...
template<class MixtureType>
CML::ePsiThermo<MixtureType>::ePsiThermo(const fvMesh& mesh)
:
    basicPsiThermo(mesh),
...
template<class MixtureType>
CML::ePsiThermo<MixtureType>::~ePsiThermo()
{}
...
template<class MixtureType>
void CML::ePsiThermo<MixtureType>::correct()
{
    if (debug)
    {
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::ePsiThermo<MixtureType>::e
(
    const scalarField& T,
    const labelList& cells
) const
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::ePsiThermo<MixtureType>::Cp
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
CML::tmp<CML::volScalarField> CML::ePsiThermo<MixtureType>::Cp() const
{
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::ePsiThermo<MixtureType>::Cv
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
CML::tmp<CML::volScalarField> CML::ePsiThermo<MixtureType>::Cv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class MixtureType>
bool CML::ePsiThermo<MixtureType>::read()
{
