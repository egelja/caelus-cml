...
template<class MixtureType>
void CML::hRhoThermo<MixtureType>::calculate()
{
...
template<class MixtureType>
CML::hRhoThermo<MixtureType>::hRhoThermo(const fvMesh& mesh)
:
    basicRhoThermo(mesh),
...
template<class MixtureType>
CML::hRhoThermo<MixtureType>::~hRhoThermo()
{}
...
template<class MixtureType>
void CML::hRhoThermo<MixtureType>::correct()
{
    if (debug)
    {
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::hRhoThermo<MixtureType>::h
(
    const scalarField& T,
    const labelList& cells
) const
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::hRhoThermo<MixtureType>::Cp
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
CML::tmp<CML::volScalarField> CML::hRhoThermo<MixtureType>::Cp() const
{
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::hRhoThermo<MixtureType>::Cv
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
CML::tmp<CML::volScalarField> CML::hRhoThermo<MixtureType>::Cv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class MixtureType>
bool CML::hRhoThermo<MixtureType>::read()
{
