...
#include "directionalKSolidThermo.hpp"
...
CML::directionalKSolidThermo::directionalKSolidThermo
(
    const fvMesh& mesh,
...
CML::directionalKSolidThermo::directionalKSolidThermo(const fvMesh& mesh)
:
...
void CML::directionalKSolidThermo::init()
{
...
CML::symmTensor CML::directionalKSolidThermo::transformPrincipal
(
    const tensor& tt,
    const vector& st
) const
...
void CML::directionalKSolidThermo::transformField
(
    symmTensorField& fld,
...
void CML::directionalKSolidThermo::correct()
{
    calculate();
...
CML::tmp<CML::volSymmTensorField>
CML::directionalKSolidThermo::directionalK() const
{
    return directionalK_;
}


void CML::directionalKSolidThermo::calculate()
{
...
CML::tmp<CML::symmTensorField> CML::directionalKSolidThermo::directionalK
(
    const label patchI
) const
{
...
bool CML::directionalKSolidThermo::read()
{
    return read(subDict(typeName + "Coeffs"));
}


bool CML::directionalKSolidThermo::read(const dictionary& dict)
{
...
bool CML::directionalKSolidThermo::writeData(Ostream& os) const
{
...
CML::Ostream& CML::operator<<(Ostream& os, const directionalKSolidThermo& s)
{
    s.writeData(os);
    return os;
}
