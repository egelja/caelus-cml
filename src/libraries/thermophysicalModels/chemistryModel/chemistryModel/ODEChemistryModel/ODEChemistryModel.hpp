...
SourceFiles
    ODEChemistryModelI.hpp
    ODEChemistryModel.cpp
...
CML::ODEChemistryModel<CompType, ThermoType>::RR()
{
    return RR_;
}
...
CML::ODEChemistryModel<CompType, ThermoType>::reactions() const
{
    return reactions_;
}
...
CML::ODEChemistryModel<CompType, ThermoType>::specieThermo() const
{
...
template<class CompType, class ThermoType>
inline CML::label
CML::ODEChemistryModel<CompType, ThermoType>::nSpecie() const
{
    return nSpecie_;
}
...
template<class CompType, class ThermoType>
inline CML::label
CML::ODEChemistryModel<CompType, ThermoType>::nReaction() const
{
    return nReaction_;
}
...
template<class CompType, class ThermoType>
CML::ODEChemistryModel<CompType, ThermoType>::ODEChemistryModel
(
    const fvMesh& mesh,
    const word& ODEModelName,
    const word& thermoTypeName
...
CML::ODEChemistryModel<CompType, ThermoType>::omega
(
    const scalarField& c,
    const scalar T,
    const scalar p
...
template<class CompType, class ThermoType>
CML::scalar CML::ODEChemistryModel<CompType, ThermoType>::omegaI
(
    const label index,
    const scalarField& c,
    const scalar T,
...
template<class CompType, class ThermoType>
void CML::ODEChemistryModel<CompType, ThermoType>::updateConcsInReactionI
(
    const label index,
    const scalar dt,
    const scalar omeg,
...
template<class CompType, class ThermoType>
void CML::ODEChemistryModel<CompType, ThermoType>::updateRRInReactionI
(
    const label index,
    const scalar pr,
    const scalar pf,
...
template<class CompType, class ThermoType>
CML::scalar CML::ODEChemistryModel<CompType, ThermoType>::omega
(
    const Reaction<ThermoType>& R,
    const scalarField& c,
    const scalar T,
...
template<class CompType, class ThermoType>
void CML::ODEChemistryModel<CompType, ThermoType>::derivatives
(
    const scalar time,
    const scalarField &c,
    scalarField& dcdt
...
template<class CompType, class ThermoType>
void CML::ODEChemistryModel<CompType, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    scalarField& dcdt,
...
CML::ODEChemistryModel<CompType, ThermoType>::tc() const
{
    scalar pf, cf, pr, cr;
    label lRef, rRef;
...
template<class CompType, class ThermoType>
CML::tmp<CML::volScalarField>
CML::ODEChemistryModel<CompType, ThermoType>::Sh() const
{
...
template<class CompType, class ThermoType>
CML::tmp<CML::volScalarField>
CML::ODEChemistryModel<CompType, ThermoType>::dQ() const
{
...
template<class CompType, class ThermoType>
CML::label CML::ODEChemistryModel<CompType, ThermoType>::nEqns() const
{
...
template<class CompType, class ThermoType>
void CML::ODEChemistryModel<CompType, ThermoType>::calculate()
{
    const volScalarField rho
    (
        IOobject
...
template<class CompType, class ThermoType>
CML::scalar CML::ODEChemistryModel<CompType, ThermoType>::solve
(
    const scalar t0,
    const scalar deltaT
)
