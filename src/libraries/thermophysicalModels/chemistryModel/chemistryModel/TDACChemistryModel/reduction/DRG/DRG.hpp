...
Class
    CML::chemistryReductionMethods::DRG
...
template<class CompType, class ThermoType>
CML::chemistryReductionMethods::DRG<CompType, ThermoType>::DRG
(
    const IOdictionary& dict,
    TDACChemistryModel<CompType, ThermoType>& chemistry
)
...
template<class CompType, class ThermoType>
void CML::chemistryReductionMethods::DRG<CompType, ThermoType>::reduceMechanism
(
    const scalarField &c,
    const scalar T,
    const scalar p
