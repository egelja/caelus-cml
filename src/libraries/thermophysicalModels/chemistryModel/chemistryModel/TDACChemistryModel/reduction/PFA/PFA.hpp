...
Class
    CML::chemistryReductionMethods::PFA
...
template<class CompType, class ThermoType>
CML::chemistryReductionMethods::PFA<CompType, ThermoType>::PFA
(
    const IOdictionary& dict,
    TDACChemistryModel<CompType, ThermoType>& chemistry
)
...
template<class CompType, class ThermoType>
void CML::chemistryReductionMethods::PFA<CompType, ThermoType>::reduceMechanism
(
    const scalarField &c,
    const scalar T,
    const scalar p
