...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::insertNode
(
    chP*& phi0,
    bn*& newNode
)
...
template<class CompType, class ThermoType>
bool CML::binaryTree<CompType, ThermoType>::inSubTree
(
    const scalarField& phiq,
    bn* y,
    chP* x
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::deleteSubTree(bn* subTreeRoot)
{
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::transplant(bn* u, bn* v)
{
    if (v != nullptr)
    {
        // u is root_
...
template<class CompType, class ThermoType>
CML::chemPointISAT<CompType, ThermoType>*
CML::binaryTree<CompType, ThermoType>::chemPSibling(bn* y)
{
    if (y->parent() != nullptr)
    {
...
template<class CompType, class ThermoType>
CML::chemPointISAT<CompType, ThermoType>*
CML::binaryTree<CompType, ThermoType>::chemPSibling(chP* x)
{
    if (size_>1)
    {
...
template<class CompType, class ThermoType>
CML::binaryNode<CompType, ThermoType>*
CML::binaryTree<CompType, ThermoType>::nodeSibling(bn* y)
{
    if (y->parent()!=nullptr)
    {
...
template<class CompType, class ThermoType>
CML::binaryNode<CompType, ThermoType>*
CML::binaryTree<CompType, ThermoType>::nodeSibling(chP* x)
{
    if (size_>1)
    {
        if (x == x->node()->leafLeft())
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::deleteAllNode(bn* subTreeRoot)
{
    if (subTreeRoot != nullptr)
    {
...
template<class CompType, class ThermoType>
CML::binaryTree<CompType, ThermoType>::binaryTree
(
    TDACChemistryModel<CompType, ThermoType>& chemistry,
    dictionary coeffsDict
)
...
template<class CompType, class ThermoType>
CML::label CML::binaryTree<CompType, ThermoType>::depth(bn* subTreeRoot)
{
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::insertNewLeaf
(
    const scalarField& phiq,
    const scalarField& Rphiq,
    const scalarSquareMatrix& A,
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::binaryTreeSearch
(
    const scalarField& phiq,
    bn* node,
    chP*& nearest
...
template<class CompType, class ThermoType>
bool CML::binaryTree<CompType, ThermoType>::secondaryBTSearch
(
    const scalarField& phiq,
    chP*& x
)
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::deleteLeaf(chP*& phi0)
{
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::balance()
{
...
template<class CompType, class ThermoType>
CML::chemPointISAT<CompType, ThermoType>*
CML::binaryTree<CompType, ThermoType>::treeMin(bn* subTreeRoot)
{
    if (subTreeRoot!=nullptr)
    {
...
template<class CompType, class ThermoType>
CML::chemPointISAT<CompType, ThermoType>*
CML::binaryTree<CompType, ThermoType>::treeSuccessor(chP* x)
{
    if (size_>1)
    {
        if (x == x->node()->leafLeft())
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::clear()
{
...
template<class CompType, class ThermoType>
bool CML::binaryTree<CompType, ThermoType>::isFull()
{
...
template<class CompType, class ThermoType>
void CML::binaryTree<CompType, ThermoType>::resetNumRetrieve()
{
