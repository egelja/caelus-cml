...
const char* CML::chemkinReader::reactionTypeNames[4] =
{
    "irreversible",
    "reversible",
...
const char* CML::chemkinReader::reactionRateTypeNames[8] =
{
    "Arrhenius",
    "thirdBodyArrhenius",
    "unimolecularFallOff",
...
const char* CML::chemkinReader::fallOffFunctionNames[4] =
{
    "Lindemann",
    "Troe",
    "SRI",
...
void CML::chemkinReader::initReactionKeywordTable()
{
...
CML::scalar CML::chemkinReader::molecularWeight
(
...
void CML::chemkinReader::checkCoeffs
(
...
void CML::chemkinReader::addReactionType
(
...
void CML::chemkinReader::addPressureDependentReaction
(
    const reactionType rType,
...
void CML::chemkinReader::addReaction
(
    DynamicList<gasReaction::specieCoeffs>& lhs,
    DynamicList<gasReaction::specieCoeffs>& rhs,
    const scalarList& efficiencies,
...
CML::chemkinReader::chemkinReader
(
    const fileName& CHEMKINFileName,
