...
Class
    CML::hhuMixtureThermo

Description
    CML::hhuMixtureThermo

SourceFiles
    hhuMixtureThermo.cpp
...
template<class MixtureType>
CML::hhuMixtureThermo<MixtureType>::hhuMixtureThermo(const fvMesh& mesh)
:
...
template<class MixtureType>
CML::hhuMixtureThermo<MixtureType>::~hhuMixtureThermo()
{}
...
template<class MixtureType>
void CML::hhuMixtureThermo<MixtureType>::calculate()
{
...
template<class MixtureType>
void CML::hhuMixtureThermo<MixtureType>::correct()
{
    if (debug)
    {
...
CML::hhuMixtureThermo<MixtureType>::hc() const
{
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::hhuMixtureThermo<MixtureType>::h
(
    const scalarField& T,
    const labelList& cells
) const
...
template<class MixtureType>
CML::tmp<CML::scalarField> CML::hhuMixtureThermo<MixtureType>::Cp
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hhuMixtureThermo<MixtureType>::Cp() const
{
    const fvMesh& mesh = T_.mesh();
...
CML::hhuMixtureThermo<MixtureType>::hu
(
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hhuMixtureThermo<MixtureType>::Tb() const
{
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hhuMixtureThermo<MixtureType>::psiu() const
{
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hhuMixtureThermo<MixtureType>::psib() const
{
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hhuMixtureThermo<MixtureType>::muu() const
{
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hhuMixtureThermo<MixtureType>::mub() const
{
...
template<class MixtureType>
bool CML::hhuMixtureThermo<MixtureType>::read()
{
