...
Class
    CML::hRhoMixtureThermo

Description
    CML::hRhoMixtureThermo

SourceFiles
    hRhoMixtureThermo.cpp
...
template<class MixtureType>
void CML::hRhoMixtureThermo<MixtureType>::calculate()
{
...
template<class MixtureType>
CML::hRhoMixtureThermo<MixtureType>::hRhoMixtureThermo(const fvMesh& mesh)
:
...
template<class MixtureType>
CML::hRhoMixtureThermo<MixtureType>::~hRhoMixtureThermo()
{}
...
template<class MixtureType>
void CML::hRhoMixtureThermo<MixtureType>::correct()
{
    if (debug)
    {
...
CML::hRhoMixtureThermo<MixtureType>::hc() const
{
...
CML::hRhoMixtureThermo<MixtureType>::h
(
    const scalarField& T,
    const labelList& cells
) const
...
template<class MixtureType>
CML::tmp<CML::scalarField>
CML::hRhoMixtureThermo<MixtureType>::Cp
(
    const scalarField& T,
    const label patchi
) const
...
template<class MixtureType>
CML::tmp<CML::volScalarField>
CML::hRhoMixtureThermo<MixtureType>::Cp() const
{
    const fvMesh& mesh = T_.mesh();
...
template<class MixtureType>
bool CML::hRhoMixtureThermo<MixtureType>::read()
{
