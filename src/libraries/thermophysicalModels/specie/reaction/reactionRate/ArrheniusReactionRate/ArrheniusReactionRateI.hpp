...
inline CML::ArrheniusReactionRate::ArrheniusReactionRate
(
    const scalar A,
    const scalar beta,
    const scalar Ta
...
inline CML::scalar CML::ArrheniusReactionRate::operator()
(
    const scalar T,
    const scalar,
    const scalarField&
...
inline void CML::ArrheniusReactionRate::write(Ostream& os) const
{
