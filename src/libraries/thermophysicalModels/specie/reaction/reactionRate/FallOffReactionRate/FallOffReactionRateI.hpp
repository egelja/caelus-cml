...
inline CML::FallOffReactionRate<ReactionRate, FallOffFunction>::
FallOffReactionRate
(
...
template<class ReactionRate, class FallOffFunction>
inline CML::scalar
CML::FallOffReactionRate<ReactionRate, FallOffFunction>::operator()
(
    const scalar T,
    const scalar p,
    const scalarField& c
...
template<class ReactionRate, class FallOffFunction>
inline void CML::FallOffReactionRate<ReactionRate, FallOffFunction>::write
(
    Ostream& os
) const
{
