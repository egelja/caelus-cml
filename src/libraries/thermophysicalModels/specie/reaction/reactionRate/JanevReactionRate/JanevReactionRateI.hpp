...
inline CML::JanevReactionRate::JanevReactionRate
(
    const scalar A,
    const scalar beta,
    const scalar Ta,
...
inline CML::scalar CML::JanevReactionRate::operator()
(
    const scalar T,
    const scalar,
    const scalarField&
...
inline void CML::JanevReactionRate::write(Ostream& os) const
{
