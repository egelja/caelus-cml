...
inline CML::LandauTellerReactionRate::LandauTellerReactionRate
(
    const scalar A,
    const scalar beta,
    const scalar Ta,
...
inline CML::scalar CML::LandauTellerReactionRate::operator()
(
    const scalar T,
    const scalar,
    const scalarField&
...
inline void CML::LandauTellerReactionRate::write(Ostream& os) const
{
