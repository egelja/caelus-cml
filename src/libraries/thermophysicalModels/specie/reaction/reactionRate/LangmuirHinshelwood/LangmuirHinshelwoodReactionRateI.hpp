...
inline CML::LangmuirHinshelwoodReactionRate::LangmuirHinshelwoodReactionRate
(
    const scalar A[],
    const scalar Ta[],
    const label co,
...
inline CML::scalar CML::LangmuirHinshelwoodReactionRate::operator()
(
    const scalar T,
    const scalar,
    const scalarField& c
...
inline void CML::LangmuirHinshelwoodReactionRate::write(Ostream& os) const
{
