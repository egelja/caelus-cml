...
inline CML::SRIFallOffFunction::SRIFallOffFunction
(
    const scalar a,
    const scalar b,
    const scalar c,
...
inline CML::SRIFallOffFunction::SRIFallOffFunction(Istream& is)
:
...
inline CML::SRIFallOffFunction::SRIFallOffFunction(const dictionary& dict)
:
...
inline CML::scalar CML::SRIFallOffFunction::operator()
(
    const scalar T,
    const scalar Pr
) const
...
inline void CML::SRIFallOffFunction::write(Ostream& os) const
{
...
(
    CML::Ostream& os,
    const CML::SRIFallOffFunction& srifof
)
{
    os  << token::BEGIN_LIST
        << srifof.a_
