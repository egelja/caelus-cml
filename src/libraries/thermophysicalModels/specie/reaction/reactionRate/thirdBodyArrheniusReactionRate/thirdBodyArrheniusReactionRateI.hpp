...
inline CML::thirdBodyArrheniusReactionRate::thirdBodyArrheniusReactionRate
(
    const scalar A,
    const scalar beta,
    const scalar Ta,
...
inline CML::scalar CML::thirdBodyArrheniusReactionRate::operator()
(
    const scalar T,
    const scalar p,
    const scalarField& c
...
inline void CML::thirdBodyArrheniusReactionRate::write(Ostream& os) const
{
