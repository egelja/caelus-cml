...
inline CML::thirdBodyEfficiencies::thirdBodyEfficiencies
(
...
inline CML::scalar CML::thirdBodyEfficiencies::M(const scalarList& c) const
{
    scalar M = 0.0;
    forAll(*this, i)
    {
...
inline void CML::thirdBodyEfficiencies::write(Ostream& os) const
{
