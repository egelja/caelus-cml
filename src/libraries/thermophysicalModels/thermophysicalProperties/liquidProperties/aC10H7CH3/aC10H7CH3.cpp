...
CML::aC10H7CH3::aC10H7CH3(const dictionary& dict)
:
    aC10H7CH3()
{
...
void CML::aC10H7CH3::writeData(Ostream& os) const
{
...
CML::Ostream& CML::operator<<(Ostream& os, const aC10H7CH3& l)
{
    l.writeData(os);
    return os;
}
