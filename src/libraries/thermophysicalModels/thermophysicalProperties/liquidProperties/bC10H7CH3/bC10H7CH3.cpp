...
CML::bC10H7CH3::bC10H7CH3(const dictionary& dict)
:
    bC10H7CH3()
{
...
void CML::bC10H7CH3::writeData(Ostream& os) const
{
...
CML::Ostream& CML::operator<<(Ostream& os, const bC10H7CH3& l)
{
    l.writeData(os);
    return os;
}
