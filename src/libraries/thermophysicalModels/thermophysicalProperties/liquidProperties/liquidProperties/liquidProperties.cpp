...
CML::scalar CML::liquidProperties::S(scalar p, scalar T) const
{
    NotImplemented;
    return 0;
}
...
void CML::liquidProperties::readIfPresent(const dictionary &dict)
{
...
void CML::liquidProperties::write(Ostream& os) const
{
...
CML::Ostream& CML::operator<<(Ostream& os, const liquidProperties& l)
{
    l.writeData(os);
    return os;
}
