...
Class
    CML::wallHeatTransferFvPatchScalarField
...
SourceFiles
    wallHeatTransferFvPatchScalarField.cpp

\*---------------------------------------------------------------------------*/

#ifndef wallHeatTransferFvPatchScalarField_HPP
#define wallHeatTransferFvPatchScalarField_HPP
