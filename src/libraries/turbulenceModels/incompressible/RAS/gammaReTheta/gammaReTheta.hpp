...
#ifndef gammaReTheta_H
#define gammaReTheta_H
...
public:
    ...
    tmp<volScalarField> DintermittencyEff() const
    {
        ...
        (
            new volScalarField("DintermittencyEff", (nut_/sigmaf_) + nu())
        );
    }
    ...
    tmp<volScalarField> DReThetaTildaEff() const
    {
        return tmp<volScalarField>
        (
            new volScalarField("DReThetaTildaEff", sigmaThetat_*(nut_ + nu()))
        );
    }
