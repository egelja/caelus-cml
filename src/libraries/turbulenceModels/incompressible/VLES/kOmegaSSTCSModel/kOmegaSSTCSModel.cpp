...
tmp<volSymmTensorField> kOmegaSSTCSModelVLES::devReff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
tmp<fvVectorMatrix> kOmegaSSTCSModelVLES::divDevReff(volVectorField& U) const
{
    return Fr_*
    (
...
tmp<fvVectorMatrix> kOmegaSSTCSModelVLES::divDevRhoReff
(
