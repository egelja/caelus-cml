...
Class
    CML::stokesFirstStandingProperties
...
SourceFiles
    stokesFirstStandingProperties.cpp
...
#ifndef stokesFirstStandingProperties_HPP
#define stokesFirstStandingProperties_HPP
...
class stokesFirstStandingProperties
:
...
public:
    ...
    TypeName("stokesFirstStandingProperties");
