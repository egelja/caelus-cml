...
#ifndef stokesSecondProperties_HPP
#define stokesSecondProperties_HPP
...
public:
    ...
    //- Runtime type information
        TypeName("stokesSecondProperties");
