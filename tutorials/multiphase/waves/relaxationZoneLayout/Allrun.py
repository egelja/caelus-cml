...
# Executing relaxationZoneLayout
print "Executing relaxationZoneLayout"
run = subprocess.Popen(['caelus.py', '-l', 'relaxationZoneLayout'], shell=pltfrm)
run.wait()
run = None

# Create stub file for paraview
open('relaxationZoneLayout.foam', 'a').close()
